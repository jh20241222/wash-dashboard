    ...
    <>
      ...
      <aside className={`sidebar ${sideOpen ? 'open' : ''}`}>
        <div className="sidebar-brand">
          ...
          <div>
            <div className="brand-name">세차현황</div>
      ...
      <style jsx global>{`
        ...
        * { margin:0; padding:0; box-sizing:border-box; }
        html { font-size:14px; }
        body {
          font-family:'Noto Sans KR',sans-serif; color:var(--black);
        ...
        .sidebar {
          ...
          background: radial-gradient(circle at 20% 8%, rgba(255,128,33,.28), transparent 28%),
            linear-gradient(180deg,#1a1a2e 0%,#101828 55%,#091E3F 100%);
          color:#eef6ff; border-right:1px solid rgba(255,255,255,.07);
          transform:translateX(-100%); transition:transform .25s ease;
        }
        .sidebar.open { transform:translateX(0); }
        @media(min-width:1024px){ .sidebar { transform:translateX(0); } .main { margin-left:260px; } .topbar { left:260px; } }
        ...
        .sidebar-brand { padding:28px 20px 20px; display:flex; align-items:center; gap:12px; }
        .brand-logo { width:44px;height:44px;border-radius:14px;background:rgba(255,128,33,.2);border:1px solid rgba(255,128,33,.3);display:flex;align-items:center;justify-content:center;font-size:22px;flex-shrink:0; }
        .brand-name { font-size:17px;font-weight:900;letter-spacing:-.03em; }
        .brand-sub { font-size:11px;color:rgba(255,255,255,.45);font-weight:600;letter-spacing:.05em; }

        .sidebar-nav { flex:1; padding:0 12px; display:flex; flex-direction:column; gap:2px; }
        .nav-item { display:flex;align-items:center;gap:12px;padding:11px 14px;border-radius:var(--radius-sm);border:none;background:transparent;color:rgba(255,255,255,.55);font-size:13.5px;font-weight:600;cursor:pointer;transition:all .18s;text-align:left;width:100%; }
        .nav-item:hover { background:rgba(255,255,255,.07);color:#fff; }
        .nav-item.active { background:rgba(255,128,33,.18);color:var(--orange);border:1px solid rgba(255,128,33,.25); }
