...
export async function insertWeekData(weekLabel,data){
  ...
  for(const c of completedPlates) await q('INSERT INTO completed_vehicles(week_label,license_plate,worker_id,work_date)VALUES($1,$2,$3,$4)',[weekLabel,safeStr(c.plate,20),safeStr(c.workerId,50),c.workDate||null]);
